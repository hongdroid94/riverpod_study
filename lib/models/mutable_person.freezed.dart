...
mixin _$MutablePerson {
  int get id =>
      throw _privateConstructorUsedError; // unfreezed data class 에서는 final 을 지정해야만 immutable이 된다
  String get name =>
      throw _privateConstructorUsedError; // unfreezed data class 에서는 final 을 지정해야만 immutable이 된다
...
class _$MutablePersonImpl
  ...
  @override
  final int id;
// unfreezed data class 에서는 final 을 지정해야만 immutable이 된다
  @override
  String name;
  @override
  String email;
...
abstract class _MutablePerson implements MutablePerson {
  ...
  @override
  int get id;
  @override // unfreezed data class 에서는 final 을 지정해야만 immutable이 된다
  String get name; // unfreezed data class 에서는 final 을 지정해야만 immutable이 된다
